			...
			<div class="row">
				...
				<div class="col-lg-6 offset-lg-1 col-md-12">
					<div class="owl-carousel active-gallery-carousel">
						...
						<!-- single gallery -->
						<div class="single-gallery">
							<img class="img-fluid" src="{{ URL::asset('img/pac2.jpg')}}" alt="">
							<div class="gallery-content">
								<div class="title align-items-center justify-content-between d-flex">
									<p>Proper Guided Tour</p>
									<h4>$56<span>/day</span></h4>
							...
							<div class="light-box">
								<a href="{{ URL::asset('img/pac2.jpg')}}" class="img-popup">
									<span class="lnr lnr-pushpin"></span>
								</a>
							</div>
						</div>
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-amenities">
						<div class="amenities-thumb">
							<img class="img-fluid" src="{{ URL::asset('img/ame1.jpg')}}" alt="">
						</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-amenities">
						<div class="amenities-thumb">
							<img class="img-fluid" src="{{ URL::asset('img/ame2.jpg')}}" alt="">
						</div>
						<div class="amenities-details">
							<div class="amenities-meta">
								<span>Within a Shor Time</span>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-amenities">
						<div class="amenities-thumb">
							<img class="img-fluid" src="{{ URL::asset('img/ame3.jpg')}}" alt="">
						</div>
						<div class="amenities-details">
							<div class="amenities-meta">
								<span>Within a Shor Time</span>
	...
	<section class="newsletter-area section_gap">
		<div class="container-fluid">
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-lg-6 offset-lg-1">
					<img class="img-fluid nw-img" src="{{ URL::asset('img/nwl-img.png')}}" alt="">
				</div>
			</div>
	</section>
	<!--================ End Newsletter Area =================-->
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-blog">
						<div class="blog-thumb">
							<img class="img-fluid" src="{{ URL::asset('img/blog/h-blog1.jpg')}}" alt="">
						</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-blog">
						<div class="blog-thumb">
							<img class="img-fluid" src="{{ URL::asset('img/blog/h-blog2.jpg')}}" alt="">
						</div>
						<div class="blog-details">
							<div class="blog-meta">
								<a href="#" class="m-gap"><span class="lnr lnr-calendar-full"></span>13th Dec</a>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="single-blog">
						<div class="blog-thumb">
							<img class="img-fluid" src="{{ URL::asset('img/blog/h-blog3.jpg')}}" alt="">
						</div>
						<div class="blog-details">
							<div class="blog-meta">
								<a href="#" class="m-gap"><span class="lnr lnr-calendar-full"></span>13th Dec</a>
